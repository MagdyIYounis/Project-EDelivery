...
define([
  ...
  function CustomerViewModel() {
    ...
    this.District_Number = ko.observable();
    this.Neighboring_Number = ko.observable();
    this.Block_Number = ko.observable();
    this.Floor_Number = ko.observable();
    this.Flat_Number = ko.observable();
    ...
    this.Save = (event) => {
      var settings = {
        ...
        data: JSON.stringify({
          Cust_Name: "stdsfdrilng",
          Governorate_Name: "stfdsfrigng",
          District_Number: 0,
