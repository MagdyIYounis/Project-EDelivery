...
define([
  ...
  function CustomerViewModel() {
    ...
    $.getJSON("http://localhost:3000/api/countries").then((data) => {
      ...
      self.Country_Op(
        new ListDataProviderView(Country, { dataMapping: dataMap })
      );
    });

    this.valueChangeCountry = function (event) {}.bind(this);
