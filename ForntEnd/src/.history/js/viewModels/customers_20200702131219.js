    ...
    var selectedListener = function (event) {
      if (event.type === "selectedChanged") {
        ...
        self
          ...
          var settings = {
            "url": "http://localhost:3000/api/Customers/1?access_token=CYoY6z4BtjjCfkHcy5CMOgrGHMPqmJpcun1vipCTcJkGHSzhBkP3tyrucZpzjaum
          ",
            "method": "GET",
            "timeout": 0,
            "headers": {
            ...
            "data": JSON.stringify({"Cust_Name":"stdsfdrilng","Governorate_Name":"stfdsfrigng","District_Number":0,"Neighboring_Number":0,"Block_Number":0,"Floor_Number":0,"Flat_Number":0,"Info":"string","Point":0,"Date":"2020-06-24T22:14:32.824Z","cityId":1}),
          };
