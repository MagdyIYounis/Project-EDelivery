      ...
      if (this.Code_Cust == "0000") {
        ...
        $.ajax(settings).done(function (response) {
          self.messagesDataprovider.push({
            severity: "confirmation Add New Customer",
        ...
        var settings = {
          url:
            ...
            Code_Cust() +
            "1?access_token=z7PGgIZW9f47GZEr84cRnSnP4qBKeYmAEEe1NCwD3uoIwnH9d71imRjL0lcS9k09",
          method: "PUT",
          timeout: 0,
          headers: {
            "Content-Type": "application/json",
        ...
        $.ajax(settings).done(function (response) {
          self.messagesDataprovider.push({
            severity: "confirmation Update Customer",
            summary: response["Cust_ID"],
            detail: "Confirmation Add Customer",
          });
          this.clear();
