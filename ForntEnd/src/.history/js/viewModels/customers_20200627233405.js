...
define([
  ...
  function CustomerViewModel() {
      ...
      $.getJSON("http://localhost:3000/api/Customers").then(function (data) {
        self.dataprovider(
          new ArrayDataProvider(data, {
            ...
            implicitSort: [{ attribute: "Date", direction: "descending" }],
          })
        );
      });
    };
    ...
    this.Save = (event, data, bindingContext) => {
      var trackerObj = ko.utils.unwrapObservable(self.NameCustomer());
      console.log(trackerObj instanceof oj.InvalidComponentTracker);
      /*var settings = {
        url:
